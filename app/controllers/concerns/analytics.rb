module Analytics
  ...
  def sample_commits_data(timeframe)
    case timeframe
    when '24h'
      { labels: ['6h ago', '12h ago', '18h ago', '24h ago'], datasets: { 'Sample Dev' => [3, 7, 2, 5] } }
    when '7d'
      { labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'], datasets: { 'Sample Dev' => [12, 19, 8, 15, 22, 10, 14] } }
    when '1m'
      { labels: ['Week 1', 'Week 2', 'Week 3', 'Week 4'], datasets: { 'Sample Dev' => [45, 52, 38, 61] } }
    when '6m'
      { labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'], datasets: { 'Sample Dev' => [180, 210, 165, 245, 190, 220] } }
    when '1y'
      { labels: ['Q1', 'Q2', 'Q3', 'Q4'], datasets: { 'Sample Dev' => [520, 680, 590, 750] } }
    else
      { labels: ['Week 1', 'Week 2', 'Week 3', 'Week 4'], datasets: { 'Sample Dev' => [12, 19, 8, 15] } }
    end
  end
end
